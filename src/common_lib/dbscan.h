...
namespace DBSCAN
{
    ...
    void Proc(std::vector<Point4DBSCAN> &pointSet, std::vector<std::vector<size_t>> &clusterSet);
    void ComputePara(std::vector<Point4DBSCAN> &pointSet);
    void ScanPoints(size_t start_Idx, std::vector<Point4DBSCAN> &pointSet, std::vector<size_t> *scanResult, size_t *minNumer);
